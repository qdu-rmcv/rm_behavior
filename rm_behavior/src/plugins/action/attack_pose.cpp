...
#include "rm_behavior/plugins/action/attack_pose.hpp"
...
AttackPoseAction::AttackPoseAction(
...
BT::PortsList AttackPoseAction::providedPorts()
{
...
bool AttackPoseAction::setMessage(visualization_msgs::msg::MarkerArray & msg)
{
...
bool AttackPoseAction::transformPoseInTargetFrame(
...
std::vector<Point> AttackPoseAction::generateCandidatePoints(const Point & enemy_position)
{
  std::vector<Point> candidates;
...
std::vector<Point> AttackPoseAction::filterFeasiblePoints(
...
Point AttackPoseAction::selectBestPoint(
...
PoseStamped AttackPoseAction::createAttackPose(
...
void AttackPoseAction::createVisualizationMarkers(
...
CreateRosNodePlugin(rm_behavior::AttackPoseAction, "AttackPose");
