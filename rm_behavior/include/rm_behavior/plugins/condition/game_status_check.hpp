...
class GameStatusCheckCondition : public BT::ConditionNode {

public:

  GameStatusCheckCondition(const std::string &name, const BT::NodeConfig &config);
...
private:
  ...
  rclcpp::Logger logger_ = rclcpp::get_logger("GameStatusCheckCondition");
